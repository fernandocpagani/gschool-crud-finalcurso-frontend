<template>
  <div>
    ...
    <ModalNewTask v-model:showModalNewTask="showModalNewTask" @getTasksEmit="getTasks"></ModalNewTask>
    ...
    <ModalNewSubtask @getTasksEmit="getTasks" v-model:showModalNewSubtask="showModalNewSubtask" :task="selectedTask"></ModalNewSubtask>
    <ModalNewTask @getTasksEmit="getTasks" v-model:showModalNewTask="showModalNewTask" :task="selectedTask"></ModalNewTask>
    <ModalNewTask v-model:showModalNewTask="showModalNewTask" @getTasksEmit="getTasks"></ModalNewTask>
                  ...
                  <div class="date-counter">
                    ...
                    <div v-if="task.taskfinishdate >= moment().format('YYYY-MM-DD')">
                      <div class="green-date">
                        <img src="/dataverde.svg" alt="">{{moment(task.taskfinishdate).format('DD/MM/YYYY') }}
                      </div>
                    </div>

                    <div v-else>
                      <div class="red-date">
                        <img src="/datavermelho.svg" alt=""> {{ moment(task.taskfinishdate).format('DD/MM/YYYY') }}
                      </div>
                    </div>
    ...
    getTasksToday() {
      axios
        ...
        .then((response) => {
          this.tasks = response.data
          this.moment = moment;
          this.titlemenu = "Tarefas de hoje";
        })
    },
